package com.hluck.composefortvsample.data/*
...
internal object MovieList {
    val categories = listOf(
        "com.hluck.composefortvsample.data.Category Zero",
        "com.hluck.composefortvsample.data.Category One",
        "com.hluck.composefortvsample.data.Category Two",
        "com.hluck.composefortvsample.data.Category Three",
        "com.hluck.composefortvsample.data.Category Four",
        "com.hluck.composefortvsample.data.Category Five"
    )
